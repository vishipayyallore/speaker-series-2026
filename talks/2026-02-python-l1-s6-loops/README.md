# Session 6: Loops & Iteration (L1 · S6)
...
| File | Focus |
| ---- | ----- |
| `01_for_loops.py` | `for` + `range()` |
| `02_while_loops.py` | `while` + countdown |
| `03_loop_controls_fizzbuzz.py` | `break` / `continue` / FizzBuzz |
| `04_calculator_loop.py` | Capstone — loop-driven calculator |
| `05`–`09` | Optional reinforcement (assignment, conversion, boolean logic) |
...
[Session 5 — Mini Project 1](../2026-01-python-l1-s5-mini-calculator/)
